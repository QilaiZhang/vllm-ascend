    ...
    double softplus_threshold)
{
    ...
    (void)query; (void)key; (void)state;
    (void)actual_seq_lengths; (void)ssm_state_indices;
    (void)num_accepted_tokens; (void)scale_value;
    (void)softplus_beta; (void)softplus_threshold;
